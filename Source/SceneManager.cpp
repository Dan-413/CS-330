...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture(
		...
		"wall");
	bReturn = CreateGLTexture(
		"../../Utilities/textures/red-swirl.jpg",
		"sharingan");
	bReturn = CreateGLTexture(
	...
	bReturn = CreateGLTexture(
		...
		"box");
	bReturn = CreateGLTexture(
		"../../Utilities/textures/glass-texture.jpg",
		"glass");
	bReturn = CreateGLTexture(
		"../../Utilities/textures/abstract.jpg",
		"cone");
	bReturn = CreateGLTexture(
		"../../Utilities/textures/brown_grain_pattern.jpg",
		"desk");
	bReturn = CreateGLTexture(
		"../../Utilities/textures/keyboard-vector.jpg",
		"keyboard");
	bReturn = CreateGLTexture(
		"../../Utilities/textures/vegeta2.jpg",
		"monitor");
	bReturn = CreateGLTexture(
		"../../Utilities/textures/gunmetal.jpg",
		"grey");
	bReturn = CreateGLTexture(
		"../../Utilities/textures/xbox-logo2.jpg",
		"xbox");
...
void SceneManager::DefineObjectMaterials()
{
	...
	clayMaterial.ambientColor = glm::vec3(0.2f, 0.3f, 0.4f);
...
void SceneManager::SetupSceneLights()
{
	...
	//Adding 2 light sources

	m_pShaderManager->setVec3Value("lightSources[0].position", 1.0f, 12.0f, 0.5f);
...
void SceneManager::RenderScene()
{
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-0.5f, 1.0f, 0.0f);
	...
	// Draw monitor
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(20.0f, 10.0f, 0.5f);
	...
	// Draw monitor screen
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(9.5f, 0.1f, 4.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 9.0f, 0.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-6.75f, 2.0f, 2.0f);
	...
	// Draw keyboard top
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(4.0f, 1.0f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 0.51f, 8.0f);
	...
	// Draw keyboard base
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(8.0f, 0.5f, 2.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 0.25f, 8.0f);
