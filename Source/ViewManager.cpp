...
namespace
{
	...
	float cameraSpeed = 0.05f; // Initial camera speed
...
// Mouse_Scroll_Callback() called to adjust camera speed based on mouse scroll input
...
void ViewManager::Mouse_Scroll_Wheel_Callback(GLFWwindow* window, double xOffset, double yOffset)
{
	...
	if (yOffset > 0)
	{
		cameraSpeed += 0.05f; // Increase speed
	}
	else
	{
		cameraSpeed -= 0.05f; // Decrease speed
		if (cameraSpeed < 0.01f)
			cameraSpeed = 0.01f; // Ensure minimum speed
	}
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	// process camera to show perspective and orthographic views
